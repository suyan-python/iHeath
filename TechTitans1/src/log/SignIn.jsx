...
function SignIn({ props }) {
  ...
  return (
    <div className="box-signup flex-col text-center mt-10 text-[clamp(1rem, 5vw, 3rem)]">
      ...
      <div className="form-area bg-green-400 border-2 w-96 ">
        <form className="content-area " onSubmit={handleSubmit}>
          ...
          <div className="sign-in-profile flex justify-between px-16 pt-4 gap-7 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <div className="btn-sign">
              <button
                type="submit"
        ...
        <div className="image-area text-[clamp(1rem, 5vw, 3rem)]">
          <img className="Logo-Website h-24 w-24" src={Logo} alt="" />
          <div className="title text-3xl py-4 text-[clamp(1rem, 5vw, 3rem)]">
            Welcomes You!
          </div>
